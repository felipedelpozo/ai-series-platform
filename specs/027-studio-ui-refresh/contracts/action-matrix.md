...
| Series         | Generate Bible       | POST     | `/api/series/:id/generate-bible`                                                   | Optional `{ details }`; refresh selected series                           |
...
| Entities       | Generate reference   | POST     | `/api/entities/:id/generate`                                                       | Optional `{ details }`; generation result                                 |
...
| Plans          | Load/create          | GET/POST | `/api/series/:id/plans`                                                            | `{ episodeNumber, details? }` for POST                                    |
